...
var fullNames = inventors.map(function (inventor) { return "".concat(inventor.first, " ").concat(inventor.last); });
...
var oldest = inventors.sort(function (a, b) { return b.passed - b.year - (a.passed - a.year); });
...
var alpha = people.sort(function (lastOne, nextOne) {
    var aLast = lastOne.split(', ')[0];
    var bLast = nextOne.split(', ')[0];
